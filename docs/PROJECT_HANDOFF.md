> **2026-09-22 首批稳定性修复源码已验证，正在隔离构建**：共享 MVU 提交锁/三方合并、22,000 条历史恢复、动作令牌、正确反伤/互杀与预览、诊断脱敏、依赖更新及非阻塞字体。23 组稳定性回归、尖塔机制、双类型与隔离字体浏览器检查通过。详见 [任务记录与未完成项](tasks/2026-09-22-stability-fixes.md)。本批仍由主代理直接处理；本地卡安装完成后另记哈希证据，当前尚不能将源码验证称为安装完成。
