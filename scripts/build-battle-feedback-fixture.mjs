...
const dir=path.resolve('tmp/ui-v465');fs.mkdirSync(dir,{recursive:true});fs.writeFileSync(dir+'/loader.cjs',"const ts=require('typescript');module.exports=function(s){return ts.transpileModule(s,{compilerOptions:{target:ts.ScriptTarget.ES2020,module:ts.ModuleKind.ESNext}}).outputText}");
