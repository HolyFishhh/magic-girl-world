...
async function v() {
  ...
  if (
    ...
    const e = _.merge({}, h, t);
    return (A(e), await replaceVariables(e, b), e);
  }
  const e = _.merge({}, h, t);
  return (A(e), _.isEqual(t, e) || (await replaceVariables(e, b)), e);
}
function E(t) {
  return _.isString(t) ? t.replace(/^[\\"'` ]*(.*?)[\\"'` ]*$/, '$1') : t;
}
function S(t, e, a = !1, s = !0) {
  if (!e) return t;
...
function w(t) {
  ...
  if ('undefined' !== e) {
    ...
    try {
      const t = { Math, math: p },
        a = p.evaluate(e, t);
      if (p.isComplex(a) || p.isMatrix(a)) return a.toString();
...
async function N(t, e, a, s = '', n = !1) {
  ...
  if (_.has(t, e)) {
    ...
    if (Array.isArray(o) && 2 === o.length) {
      ...
      ((o[0] = a), _.set(t, e, o));
      const d = s ? `(${s})` : '',
        p = `${E(JSON.stringify(l))}->${E(JSON.stringify(a))} ${d}`;
      return (
        i && _.set(i, e, p),
        r && _.set(r, e, p),
        console.info(`Set '${e}' to '${E(JSON.stringify(a))}' ${d}`),
    ...
    }
    {
      ...
      const d = s ? `(${s})` : '',
        ...
        f = `${E(JSON.stringify(l))}->${p} ${d}`;
      return (
        i && _.set(i, e, f),
        r && _.set(r, e, f),
        console.info(`Set '${e}' to '${p}' ${d}`),
        n && (await eventEmit(c.SINGLE_VARIABLE_UPDATED, t, e, l, a)),
        !0
      );
    }
...
async function j(t, e) {
    ...
    d = (function (t) {
      ...
      for (; a < t.length; ) {
        ...
        ((('set' === n && f.length >= 2) ||
          ...
          ('add' === n && 2 === f.length)) &&
          (m = !0),
          m && e.push({ command: n, fullMatch: p, args: f, reason: l }),
          (a = c));
      }
      return e;
    })(substitudeMacros(t)),
  ...
  const h = function (t) {
    ...
    b = e.schema,
    A = b?.strictTemplate ?? !1,
    I = b?.concatTemplateArray ?? !0,
    N = b?.strictSet ?? !1;
  for (const t of d) {
    const a = T(E(t.args[0])),
      d = t.reason ? `(${t.reason})` : '';
    let p = '';
    switch (((m = t), t.command)) {
      case 'set': {
        ...
        let r = w(t.args.length >= 3 ? t.args[2] : t.args[1]);
        r instanceof Date && (r = r.toISOString());
        let o = !1;
        if (N || !Array.isArray(s) || 2 !== s.length || 'string' != typeof s[1] || Array.isArray(s[0]))
        ...
        (n(), o && (l = l[0]));
        ((p =
          !N && i(s) && Array.isArray(l)
            ? `${E(JSON.stringify(s[0]))}->${E(JSON.stringify(l[0]))} ${d}`
            : `${E(JSON.stringify(s))}->${E(JSON.stringify(l))} ${d}`),
          (y = !0),
      ...
      case 'assign': {
        ...
        if (2 === t.args.length) {
          ...
          if (
            ...
            ((n = S(n, i && r(i) ? i.template : void 0, A, I)),
              o.push(n),
              (p = `ASSIGNED ${JSON.stringify(n)} into array '${a}' ${d}`),
              (f = !0));
            ...
            (_.merge(o, n), (p = `MERGED object ${JSON.stringify(n)} into object '${a}' ${d}`), (f = !0));
          }
          ...
          Array.isArray(l) && 'number' == typeof c
            ? ((n = S(n, m, A, I)),
              l.splice(c, 0, n),
              (p = `ASSIGNED ${JSON.stringify(n)} into '${a}' at index ${c} ${d}`),
              (f = !0))
            : _.isObject(l)
              ? ((n = S(n, m, A, I)),
                (l[String(c)] = n),
                (p = `ASSIGNED key '${c}' with value ${JSON.stringify(n)} into object '${a}' ${d}`),
                (f = !0))
              : ((l = {}),
                _.set(e.stat_data, a, l),
                (n = S(n, m, A, I)),
                (l[String(c)] = n),
                (p = `CREATED object at '${a}' and ASSIGNED key '${c}' ${d}`),
                (f = !0));
        }
        if (!f) {
        ...
        }
        {
          ...
          ((y = !0), console.info(p), await eventEmit(c.SINGLE_VARIABLE_UPDATED, e.stat_data, a, l, t));
        }
        break;
      }
      case 'unset':
      ...
      case 'remove': {
        ...
        let s,
          n = a;
        if (t.args.length > 1) ((s = w(t.args[1])), 'string' == typeof s && (s = E(s)));
        else {
          const t = _.toPath(a),
            e = t.pop();
        ...
        const r = t.args.length > 1 ? w(t.args[1]) : void 0;
        let o = !1;
        if (void 0 === r) {
          const t = _.get(e.stat_data, a);
          ...
          if (Array.isArray(t)) {
            ...
            if ('number' == typeof r) {
              ...
              if (s >= 0 && s < e.length) {
                const n = e[s];
                (_.unset(t, n), (o = !0), (p = `REMOVED ${s + 1}th entry ('${n}') from object '${a}' ${d}`));
              }
            } else {
              const e = String(r);
              _.has(t, e) && (delete t[e], (o = !0), (p = `REMOVED key '${e}' from object '${a}' ${d}`));
            }
        }
        if (!o) {
      ...
      case 'add': {
        ...
        }
        {
          ...
          if (f) {
            ...
            const u = _.get(e.stat_data, a);
            ((p = l
              ? `${JSON.stringify(s[0])}->${JSON.stringify(u[0])} ${d}`
              : `${JSON.stringify(s)}->${JSON.stringify(u)} ${d}`),
              (y = !0),
              console.info(
                `ADDED date '${a}' from '${f.toISOString()}' to '${o.toISOString()}' by delta '${i}'ms ${d}`,
              ),
              await eventEmit(c.SINGLE_VARIABLE_UPDATED, e.stat_data, a, s, u));
          } else {
            if ('number' != typeof o) {
    ...
    p && (_.set(s.stat_data, a, p), _.set(l.stat_data, a, p));
  }
  if (
...
async function L() {
  ...
  try {
    const a = await (async function () {
      let t = [];
      try {
        t = await getChatMessages(-2, { role: 'assistant', include_swipes: !0 });
      } catch (t) {}
      if (!t || t.length <= 0) {
        const e = await getChatMessages(0, { include_swipes: !0 });
        if (!(e && e.length > 0)) throw new Error('不存在任何一条消息');
        t = e;
      }
      const e = t[0],
        a = e.swipes_data[e.swipe_id];
      return { message: e, variables: a };
    })();
    ((t = a.message),
      (e = a.variables ?? {
        display_data: {},
  ...
  if (
    ...
    _.has(e, 'initialized_lorebooks') || (e.initialized_lorebooks = {}),
    Array.isArray(e.initialized_lorebooks))
  ) {
    console.warn('Old "initialized_lorebooks" array format detected. Migrating to the new object format.');
    const t = e.initialized_lorebooks,
      a = {};
    for (const e of t) a[e] = [];
    e.initialized_lorebooks = a;
  }
  (e.stat_data || (e.stat_data = {}), e.schema || (e.schema = { extensible: !1, properties: {}, type: 'object' }));
  const a = await R(e);
  if (a) {
  }
  if (a || !e.schema || _.isEmpty(e.schema)) {
    const t = m(_.cloneDeep(e.stat_data));
    (o(t)
      ? (_.has(e.stat_data, '$meta.strictTemplate') && (t.strictTemplate = e.stat_data.$meta?.strictTemplate),
        _.has(e.stat_data, '$meta.concatTemplateArray') &&
          (t.concatTemplateArray = e.stat_data.$meta?.concatTemplateArray),
        _.has(e.stat_data, '$meta.strictSet') && (t.strictSet = e.stat_data.$meta?.strictSet),
        (e.schema = t))
      : console.error('Generated schema is not an object schema, which is unexpected for stat_data root'),
      y(e.stat_data));
  }
  if (a) {
    (console.info('Init chat variables.'), await insertOrAssignVariables(e));
    for (let a = 0; a < t.swipes.length; a++) {
      const s = _.cloneDeep(e);
      (await j(t.swipes[a], s), await setChatMessage({ data: s }, t.message_id, { refresh: 'none', swipe_id: a }));
    }
...
const C = ['重新处理变量', '重新读取初始变量'];
let G = 0;
function J() {
  (!(function () {
    const t = getScriptButtons(getScriptId()),
      e = t.map(t => t.name);
    for (const a of C.filter(t => !e.includes(t))) t.push({ name: a, visible: !1 });
    ...
    eventOnButton('重新读取初始变量', async function () {
      ...
      try {
        if (!(await R(t)))
          return (
            ...
            void toastr.error('没有找到 InitVar 数据', '', { timeOut: 3e3 })
          );
      } catch (t) {
      ...
      ((s.stat_data = _.merge(s.stat_data, a.stat_data)),
...
function P() {
  return {
    ...
    parseMessage: async function (t, e) {
      ...
      return (await k(t, a), a.new_variables);
    },
    ...
    setMvuVariable: async function (t, e, a, { reason: s = '', is_recursive: n = !1 } = {}) {
      return await N(t.stat_data, e, a, s, n);
    },
...
($(async () => {
  (J(),
    (function () {
      const t = P();
      (_.set(window, 'Mvu', t), _.set(window.parent, 'Mvu', t));
    })(),
    eventOn(tavern_events.GENERATION_STARTED, L),
    eventOn(tavern_events.MESSAGE_SENT, L),
  ...
  $(window).on('unload', () => {
    (eventRemoveListener(tavern_events.GENERATION_STARTED, L),
      eventRemoveListener(tavern_events.MESSAGE_SENT, L),
      eventRemoveListener(tavern_events.MESSAGE_SENT, V),
      eventRemoveListener(tavern_events.MESSAGE_RECEIVED, V),
      eventRemoveListener(l, k));
  }));
