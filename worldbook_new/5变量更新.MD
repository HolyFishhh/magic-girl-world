  ...
  format: |-
    <UpdateVariable>
      <Analysis>$(IN ENGLISH$)
        ...
        - `status.time`: Maintain format `YY年MM月DD日 HH:mm`. Update when time advances. Use `_.set`.
        - `status.location`: Update when the character changes place. Use `_.set`.
        - `status.profession`: update fields individually when job or core ability changes. Use `_.set`.
        ...
        - `factions.invasion`: Adjust when need (0-7). Use `_.set`. Do not exceed bounds.
    ...
    <UpdateVariable>
      <Analysis>
        ...
        - `status.time`: Advanced by 20 minutes (keep `YY年MM月DD日 HH:mm`).
        - `status.location`: Changed to the tavern.
        - `status.profession`: No change (object remains).
        - `npcs.elara.affection`: Increased due to the kind conversation.
      </Analysis>
      _.set('status.time', '2030年07月18日 16:35', '2030年07月18日 16:55');        // Time passes during travel.
      _.set('status.location', '阳石广场（中央喷泉）', '低语酒馆（后厅）');        // Character moved to a new location.
