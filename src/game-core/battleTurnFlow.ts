...
const PLAYER_END_FLOW_STEPS: readonly BattleTurnFlowStep[] = [
  'player_cards_end', 'player_relics_end', 'player_abilities_end', 'player_orbs_end', 'player_statuses_end',
  'player_threshold_execute',
  'scheduled_turn_end', 'player_summons_action', 'advance_turn',
];
const ENEMY_TURN_FLOW_STEPS: readonly BattleTurnFlowStep[] = [
  ...
  'enemy_abilities_end', 'enemy_orbs_end', 'enemy_statuses_end', 'enemy_threshold_execute', 'enemy_escape',
];
const PLAYER_BEGIN_FLOW_STEPS: readonly BattleTurnFlowStep[] = [
  'temporary_modifiers_clear', 'player_begin', 'player_summons_reset', 'player_block_reset',
  'player_energy_reset', 'scheduled_turn_start', 'scheduled_before_draw', 'player_draw', 'scheduled_after_draw',
  'player_abilities_start', 'player_relics_start', 'player_statuses_before_action',
];
