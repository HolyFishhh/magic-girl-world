...
export const TRIGGER_DEFINITIONS: Readonly<Record<string, TriggerDefinition>> = {
  ...
  enemy_gain_buff: { id: 'enemy_gain_buff', name: '对方获得增益时', icon: '✨', color: '#d97706' },
  enemy_gain_debuff: { id: 'enemy_gain_debuff', name: '对方获得减益时', icon: '🌫️', color: '#65a30d' },
  enemy_lose_buff: { id: 'enemy_lose_buff', name: '对方失去增益时', icon: '💨', color: '#0891b2' },
  enemy_lose_debuff: { id: 'enemy_lose_debuff', name: '对方失去减益时', icon: '🌈', color: '#c026d3' },
