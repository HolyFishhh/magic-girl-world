...
export declare function resolveDynamicCardCost(card: DynamicCostLifecycleCard, rules: readonly DynamicCardCostRule[], context: DynamicCardCostContext): number | 'energy' | undefined;
...
export declare function resolveDynamicCardCostAtPlay(card: DynamicCostLifecycleCard, rules: readonly DynamicCardCostRule[], context: Omit<DynamicCardCostContext, 'timing'>): number | 'energy' | undefined;
