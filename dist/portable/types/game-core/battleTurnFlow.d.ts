export declare const BATTLE_TURN_FLOW_STEPS: readonly ["player_cards_end", "player_relics_end", "player_abilities_end", "player_orbs_end", "player_statuses_end", "player_threshold_execute", "scheduled_turn_end", "player_summons_action", "advance_turn", "enemy_block_reset", "enemy_resources_reset", "enemy_summons_reset", "enemy_abilities_start", "enemy_action", "enemy_summons_action", "enemy_next_intent", "enemy_abilities_end", "enemy_orbs_end", "enemy_statuses_end", "enemy_threshold_execute", "enemy_escape", "temporary_modifiers_clear", "player_begin", "player_summons_reset", "player_block_reset", "player_energy_reset", "scheduled_turn_start", "scheduled_before_draw", "player_draw", "scheduled_after_draw", "player_abilities_start", "player_relics_start", "player_statuses_before_action"];
export type BattleTurnFlowStep = (typeof BATTLE_TURN_FLOW_STEPS)[number];
export declare const BATTLE_START_FLOW_STEPS: readonly ["initial_player_reset", "player_stance_battle_start", "enemy_stance_battle_start", "player_abilities_battle_start", "enemy_abilities_battle_start", "player_abilities_gain_initial", "enemy_abilities_gain_initial", "player_relics_ability_gain_initial", "player_relics_battle_start", "initial_player_turn"];
