export declare const BATTLE_TURN_FLOW_STEPS: readonly ["player_cards_end", "player_relics_end", "player_abilities_end", "player_statuses_end", "scheduled_turn_end", "advance_turn", "enemy_block_reset", "enemy_abilities_start", "enemy_action", "enemy_next_intent", "enemy_abilities_end", "enemy_statuses_end", "temporary_modifiers_clear", "player_begin", "scheduled_turn_start", "player_block_reset", "player_energy_reset", "scheduled_before_draw", "player_draw", "scheduled_after_draw", "player_abilities_start", "player_relics_start"];
export type BattleTurnFlowStep = (typeof BATTLE_TURN_FLOW_STEPS)[number];
export declare const BATTLE_START_FLOW_STEPS: readonly ["player_abilities_battle_start", "enemy_abilities_battle_start", "player_abilities_gain_initial", "enemy_abilities_gain_initial", "player_relics_ability_gain_initial", "player_relics_battle_start"];
