...
2. 在角色管理中明确选择显示名为 `魔法少女世界 1.0.3` 的新卡，不要继续使用旧版本角色。
...
剧情模式只需角色卡。爬塔模式需要 `1.0.3` 或更高版本的“魔法少女世界设计辅助器”：开始页与设置悬浮窗会自动检测，缺失或版本过旧时可点击安装/更新，由 SillyTavern 官方安装器从本仓库 `extension` 分支安装；安装完成后刷新酒馆即可。旧手动复制安装不再自动删除或迁移；需要自行安装当前版本组件。
